...
public abstract class Display {
    ...
    public void ingresarTexto(String T, int a, int b) {
        Fondo[a][b] = T;
    }

    // Metodo para ingresar texto con la condicion que cada char '/' sume una unidad en el eje y.
    public void acomodarTexto(String X, int a, int b) {
        limpiarDisplay();
        String aux = "";
    ...
    // Método para únicamente borrar la terminal (el contenido previo se conserva)
    public void desplazarDisplay() {
        System.out.print("\033[H\033[2J");
        System.out.flush();
    }
    ...
    // Método abstracto para el ingreso de las aplicaciones (diferentes por cada programa)
